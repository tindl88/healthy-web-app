...
const IconMemo: React.FC<React.SVGAttributes<Record<string, unknown>>> = ({ width = 32 }) => {
  return (
    <svg
      width={width}
      viewBox="0 0 32 32"
    ...
    >
      ...
      <path
        d="M29.5491 10.6651L28.5569 9.67398C27.9562 9.07205 26.9812 9.07327 26.3793 9.67398L25.452 10.6025L28.6208 13.7712L29.5491 12.8438C30.1499 12.242 30.1499 11.267 29.5491 10.6651H29.5491Z"
        fill="#FF963C"
      />
