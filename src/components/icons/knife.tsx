...
const IconKnife: React.FC<React.SVGAttributes<Record<string, unknown>>> = ({ width = 56 }) => {
  return (
    <svg
      width={width}
      viewBox="0 0 56 56"
    ...
    >
      ...
      <g clipPath="url(#clip0_47865_59)">
        <g clipPath="url(#clip1_47865_59)">
          <path
